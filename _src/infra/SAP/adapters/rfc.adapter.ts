  ...
  async postMaterialWM(material: PostMaterialSAPWM): Promise<ResponseMaterialWM | SapPostError> {
    try {
      const input = {
        ...
        'I_VLTYP': material.props.storageTypeOrigin,
        'I_VLBER': material.props.storageSectionOrigin,
        'I_VLPLA': material.props.binOrigin,
        'I_VLENR': material.props.UDOrigin.padStart(20, '0'),
        'I_NLTYP': material.props.storageTypeDestination,
        'I_NLBER': material.props.storageSectionDestination,
        'I_NLPLA': material.props.binDestination,
